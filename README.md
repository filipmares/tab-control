...
not closed by Tab Control. It is not a separate Tab Control history. All
processing happens locally; Tab Control does not collect, store, or transmit
browsing data. See [PRIVACY.md](PRIVACY.md).
